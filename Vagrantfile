...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "alimac-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/alimac"
  #   chef.validation_client_name = "alimac-validator"
  #   chef.validation_key_path = ".chef/alimac-validator.pem"
  # end
end
